...
protected:
	...
	void localPipelineInit() {
		P1.init(this, "resources/shaders/compiled/shader.vert.spv", "resources/shaders/compiled/shader.frag.spv", { &descriptorSetLayoutGlobal.descriptorSetLayout, &descriptorSetLayoutObject.descriptorSetLayout });
	}
