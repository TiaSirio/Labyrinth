...
# Update package list
sudo apt update
sudo apt-get install -y cmake gcc g++ python3-pip curl
...
if [[ "$choice_ifw" == "y" ]]; then
    ...
    # Install IFW
    echo Installing IFW...
    aqt install-tool --outputdir %IFW_INSTALL_DIR% linux desktop tools_ifw %IFW_VERSION%
...
echo "====================================="
echo "Do you want to install Doxygen to create the documentation? (Y or N)"
echo "====================================="
